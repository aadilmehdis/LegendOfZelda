...
Missile::Missile(glm::vec3 origin, glm::vec3 velocity, glm::mat4 rotate) {
    ...
    std::vector<GLfloat> vertex_buffer  = makeFrustum(20, 1.75, 2, 2, true, 0, 0, 0 + z_pullBack); 
    std::vector<GLfloat> vertex_buffer1  = makePrism(20, 2, 8, true, 0, 0, -2 + z_pullBack);
    std::vector<GLfloat> vertex_buffer2  = makeFrustum(20, 2, 1,4, true, 0, 0, -10 + z_pullBack);
    std::vector<GLfloat> vertex_buffer3  =  makePyramid(20, 1,10,false,0,0,-14 + z_pullBack);
