...
Health::Health(glm::vec3 origin) {
    ...
    this->object1 = create3DObject(GL_TRIANGLES, vertex_buffer.size()/3, vertex_buffer.data(), COLOR_JET_TAIL, GL_FILL);
    this->object2 = create3DObject(GL_LINES, vertex_buffer.size()/3, vertex_buffer.data(), COLOR_JET_WING, GL_LINE);
}
